...
(put 'org-agenda-windows 'custom-loads '(org))
...
(put 'org-progress 'custom-loads '(org))
(put 'pop3 'custom-loads '(pop3))
(put 'languages 'custom-loads '(ps-mode ada-mode antlr-mode asm-mode cus-edit cfengine cperl-mode dcl-mode delphi f90 fortran hideshow icon idlwave info-look ld-script m4-mode meta-mode modula2 octave-mod pascal perl-mode prolog python sgml-mode sh-script sieve simula tcl vera-mode verilog-mode vhdl-mode))
...
(put 'gnus 'custom-loads '(gnus gnus-art gnus-async gnus-delay gnus-demon gnus-diary gnus-dup gnus-eform gnus-uu deuglify gnus-sieve gnus-soup gnus-undo gnus-win mail-source mm-url nnimap nnmail nntp spam-stat))
...
(put 'multimedia 'custom-loads '(gnus-audio image-dired mm-decode thumbs))
...
(put 'vc 'custom-loads '(log-edit vc vc-arch vc-bzr vc-cvs vc-hg vc-mcvs vc-mtn vc-rcs vc-sccs vc-svn))
...
(put 'org-agenda-time-grid 'custom-loads '(org))
...
(put 'org-agenda-startup 'custom-loads '(org))
...
(put 'processes 'custom-loads '(sql ansi-color comint compile executable cus-edit flyspell grep metamail pcomplete rcompile rlogin shell socks term))
...
(put 'org-agenda-sorting 'custom-loads '(org))
