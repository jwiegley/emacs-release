...
(put 'reftex-table-of-contents-browser 'custom-loads '("reftex"))
...
(put 'texmathp 'custom-loads '("reftex"))
...
(put 'reftex-defining-label-environments 'custom-loads '("reftex"))
...
(put 'languages 'custom-loads '("cus-edit" "info-look" "ada-mode" "asm-mode" "c-mode" "cperl-mode" "cplus-md" "dcl-mode" "fortran" "hideshow" "icon" "m4-mode" "meta-mode" "modula2" "octave-mod" "pascal" "perl-mode" "prolog" "sh-script" "simula" "tcl-mode" "vhdl-mode" "sgml-mode"))
(put 'reftex-miscellaneous-configurations 'custom-loads '("reftex"))
...
(put 'mouse 'custom-loads '("mouse" "menu-bar" "avoid" "goto-addr" "mouse-sel" "msb" "strokes"))
...
(put 'speedbar-faces 'custom-loads '("speedbar"))
...
(put 'gnus 'custom-loads '("gnus-art" "gnus" "gnus-cache" "gnus-demon" "gnus-dup" "gnus-eform" "gnus-uu" "gnus-win" "nnmail"))
(put 'cperl-affected-by-hairy 'custom-loads '("cperl-mode"))
(put 'reftex-making-and-inserting-labels 'custom-loads '("reftex"))
...
(put 'profile 'custom-loads '("profile"))
...
(put 'help 'custom-loads '("help" "cus-edit" "info-look" "info" "man"))
(put 'widget-documentation 'custom-loads '("wid-edit"))
(put 'forms 'custom-loads '("forms"))
(put 'gnus-score-various 'custom-loads '("gnus"))
...
(put 'reftex-viewing-cross-references-and-citations 'custom-loads '("reftex"))
...
(put 'reftex-optimizations-for-large-documents 'custom-loads '("reftex"))
...
(put 'reftex-fontification-configurations 'custom-loads '("reftex"))
(put 'auto-insert 'custom-loads '("autoinsert"))
(put 'abbrev 'custom-loads '("files" "cus-edit" "dabbrev" "expand" "hippie-exp"))
(put 'ediff-merge 'custom-loads '("ediff-init" "ediff-merg"))
(put 'vhdl-signal-syntax 'custom-loads '("vhdl-mode"))
...
(put 'tools 'custom-loads '("add-log" "compare-w" "diff" "ediff" "emerge" "gud" "rcompile" "speedbar" "tempo" "vc" "which-func" "copyright" "compile" "etags" "make-mode"))
(put 'gnus-topic 'custom-loads '("gnus-topic"))
(put 'sgml 'custom-loads '("sgml-mode"))
(put 'keyboard 'custom-loads '("chistory" "type-break"))
...
(put 'basic-faces 'custom-loads '("cus-edit"))
...
(put 'environment 'custom-loads '("cus-edit" "dired" "dos-vars"))
...
(put 'games 'custom-loads '("bruce" "decipher" "dunnet" "gametree" "gomoku" "handwrite" "landmark" "mpuz" "solitaire" "spook" "yow"))
...
(put 'ispell 'custom-loads '("ispell" "ispell4"))
...
(put 'reftex-referencing-labels 'custom-loads '("reftex"))
...
(put 'applications 'custom-loads '("calendar" "cus-edit" "ispell4" "uniquify" "spell"))
(put 'terminal 'custom-loads '("terminal"))
(put 'shadow 'custom-loads '("shadowfile" "shadow"))
(put 'internal 'custom-loads '("startup" "cus-edit"))
(put 'lisp 'custom-loads '("lisp" "cmuscheme" "ielm" "backquote" "xscheme" "advice" "bytecomp" "checkdoc" "cl-indent" "cust-print" "edebug" "elp" "find-func" "pp" "profile" "shadow" "trace" "scheme"))
...
(put 'editing 'custom-loads '("simple" "indent" "paragraphs" "auto-show" "cus-edit" "outline" "hscroll" "vcursor" "view" "picture"))
...
(put 'data 'custom-loads '("arc-mode" "forms" "hexl" "jka-compr" "saveplace" "sort" "tar-mode" "time-stamp"))
(put 'mail 'custom-loads '("simple" "startup" "ph" "time" "gnus" "message" "emacsbug" "feedmail" "mail-extr" "mail-hist" "mail-utils" "mailalias" "metamail" "mh-e" "mspools" "rmail" "sendmail" "smtpmail" "supercite" "uce"))
...
(put 'vhdl-word-case 'custom-loads '("vhdl-mode"))
...
(put 'c 'custom-loads '("cc-vars" "cmacexp" "hideif"))
(put 'nnmail-prepare 'custom-loads '("nnmail"))
(put 'processes 'custom-loads '("comint" "cus-edit" "rcompile" "rlogin" "shell" "term" "metamail" "compile" "executable" "flyspell"))
...
(custom-put-if-not 'appt-interval 'custom-version "20.3")
(custom-put-if-not 'appt-interval 'standard-value t)
...
(custom-put-if-not 'gnus-article-hide-pgp-hook 'custom-version "20.3")
(custom-put-if-not 'gnus-article-hide-pgp-hook 'standard-value t)
...
(custom-put-if-not 'display-time-mode 'custom-version "20.3")
(custom-put-if-not 'display-time-mode 'standard-value t)
...
(custom-put-if-not 'vhdl 'custom-version "20.3")
...
(custom-put-if-not 'gnus-show-traditional-method 'custom-version "20.3")
(custom-put-if-not 'gnus-show-traditional-method 'standard-value t)
...
(defvar custom-versions-load-alist '((20.3 "find-func") ("20.3" "desktop" "easymenu" "hscroll" "dabbrev" "ffap" "rmail" "paren" "sh-script" "mailabbrev" "frame" "uce" "mouse" "diary-lib" "sendmail" "debug" "avoid" "hexl" "vcursor" "time" "vc" "compile" "etags" "octave-mod" "help" "browse-url" "add-log" "gnus-art" "vc-hooks" "cus-edit" "appt" "replace"))
