...
(put 'tramp 'custom-loads '(tramp tramp-fish tramp-ftp tramp-cache tramp-smb))
...
(put 'org-progress 'custom-loads '(org-clock org))
(put 'pop3 'custom-loads '(pop3))
(put 'languages 'custom-loads '(ps-mode ada-mode antlr-mode asm-mode cus-edit cfengine cperl-mode css-mode dcl-mode delphi f90 fortran hideshow icon idlwave info-look ld-script m4-mode meta-mode modula2 nxml-mode octave-mod pascal perl-mode prolog python rng-valid sgml-mode sh-script sieve simula tcl vera-mode verilog-mode vhdl-mode))
...
(put 'extensions 'custom-loads '(cust-print eldoc ido page-ext sha1 time-stamp wid-edit xesam))
...
(put 'multimedia 'custom-loads '(doc-view gnus-audio image-dired mm-decode thumbs))
...
(put 'org-structure 'custom-loads '(org org-list))
...
(put 'org-export-ascii 'custom-loads '(org-exp))
...
(put 'help 'custom-loads '(apropos cus-edit ehelp help-fns help-at-pt help-mode info info-look man help-macro tutorial woman))
...
(put 'org-export-translation 'custom-loads '(org-exp))
...
(put 'org-export-html 'custom-loads '(org-agenda org-exp org-jsinfo org-export-latex))
...
(put 'org-export 'custom-loads '(org-exp org-export-latex))
...
(put 'mime 'custom-loads '(mailcap mm-bodies mm-util mm-encode pgg-def rfc1843 rmailmm smime))
...
(put 'tools 'custom-loads '(calculator add-log compare-w compile copyright diff diff-mode ebrowse ediff elide-head emerge etags flymake gdb-ui glasses grep gud make-mode pcvs-defs rcompile sieve smerge-mode speedbar tempo vc which-func))
...
(put 'org-export-tables 'custom-loads '(org-exp))
...
(put 'wp 'custom-loads '(bib-mode ebnf2ps enriched lpr nroff-mode nxml-mode printing ps-print refbib refer rng-valid rst table cus-edit tildify view whitespace))
...
(put 'org 'custom-loads '(org org-attach org-exp org-id org-mouse org-publish org-remember))
...
(put 'convenience 'custom-loads '(autoinsert autorevert bs calculator completion cua-base dabbrev ffap filecache filesets follow hippie-exp ibuffer ido imenu iswitchb kmacro linum master complete pc-select repeat ruler-mode speedbar windmove))
...
(put 'texinfo 'custom-loads '(informat texinfo))
...
(put 'org-export-htmlize 'custom-loads '(org-exp))
...
(put 'font-lock-faces 'custom-loads '(nxml-mode))
(put 'org-link 'custom-loads '(org org-mew org-wl))
...
(put 'applications 'custom-loads '(calc calendar doc-view erc eshell cus-edit ispell "newst-backend" rcirc ses spell uniquify))
...
(put 'org-export-icalendar 'custom-loads '(org-exp))
...
(put 'data 'custom-loads '(arc-mode conf-mode dns-mode forms generic-x hexl remember saveplace snmp-mode sort tar-mode time-stamp timeclock whitespace))
...
(put 'calendar 'custom-loads '(appt calendar cal-x cal-china cal-dst cal-html solar cal-tex diary-lib holidays icalendar midnight org todo-mode))
...
(put 'org-faces 'custom-loads '(org-faces org))
